      ...
      <div className="mx-auto max-w-2xl">
        ...
        <motion.div variants={BLOCK_VARIANTS} className="mt-8 flex justify-center">
          <button
            ...
            className="btn-fluid inline-flex min-h-12 items-center gap-2 rounded-xl border border-accent-primary/30 bg-accent-subtle px-6 py-3 text-sm font-medium text-accent-primary transition-all duration-200 hover:border-accent-primary hover:bg-accent-primary/10 active:scale-95"
          >
