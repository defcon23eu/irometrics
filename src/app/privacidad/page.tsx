  ...
  return (
    <main className="min-h-screen px-6 py-16">
      <article className="mx-auto max-w-2xl prose prose-invert prose-sm">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-text-primary">
          1. Responsable del tratamiento
        </h2>
        <p className="text-text-secondary text-sm leading-relaxed">
          Raúl Balaguer Moreno · Investigador principal · Universidad Nacional
          de Educación a Distancia (UNED) · Contacto:{' '}
          <a href="mailto:rbalaguer16@alumno.uned.es" className="text-text-accent underline">
        ...
        <div className="mt-12 pt-8 border-t border-border-default">
          <Link
            href="/"
            className="text-text-accent underline text-sm"
          >
            ← Volver al inicio
          </Link>
        </div>
